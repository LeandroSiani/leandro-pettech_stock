...
import { LoggingInterceptor } from 'src/shared/intercepetors/logging.interceptor';
...
export class StockController {
  ...
  @UseGuards(AuthGuard)
  @Get()
  async getStocks(@Query('limit') limit: number, @Query('page') page: number) {
    return this.stockService.getStocks(limit, page);
  }
